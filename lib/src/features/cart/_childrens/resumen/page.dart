...
part 'package:breeds/src/features/cart/_childrens/resumen/_sections/body.dart';
part 'package:breeds/src/features/cart/_childrens/resumen/_sections/bottom.dart';
part 'package:breeds/src/features/cart/_childrens/resumen/_sections/item_resum.dart';
part 'package:breeds/src/features/cart/_childrens/resumen/_sections/item_total.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarGlobal(
        ...
        haveSearch: false,
        title: BreedUiValues.confirmationPurchase,
        havCart: false,
      ),
